...
- [ ] Add availability metric (fraction of targets with non-null CBG estimate) per combination
...
- [ ] Draft CBG Pipeline Taxonomy section (3-phase abstraction + variant table)
