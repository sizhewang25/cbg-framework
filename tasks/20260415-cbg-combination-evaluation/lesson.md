...
- **Arithmetic centroid on planar_circle > geometric centroid**: C1 (planar_circle+arith, 333 km) slightly beats B1 (planar_circle+geom, 395 km). The area-weighted Shapely centroid doesn't always help — extracting boundary vertices and averaging can be more robust for skewed intersection polygons.
