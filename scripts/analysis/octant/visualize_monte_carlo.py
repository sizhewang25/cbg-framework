...
Usage:
    python -m scripts.analysis.octant.visualize_monte_carlo          # built-in demo
    python -m scripts.analysis.octant.visualize_monte_carlo --target pittsburgh
"""
...
def visualize_monte_carlo(
    ...
    if output_path is None:
        output_path = f'scripts/analysis/octant/figures/monte_carlo_{target_name}.pdf'
