...
Usage:
    python -m scripts.analysis.octant.visualize_octant_geolocation
    python -m scripts.analysis.octant.visualize_octant_geolocation --asn 7922 --n-targets 10 --seed 42
    python -m scripts.analysis.octant.visualize_octant_geolocation --output-dir /tmp/octant_viz
"""
...
from scripts.analysis.cbg_feasibility.rtt_model import haversine_distance
...
from scripts.analysis.octant.visualize_monte_carlo import COLORS_BLIND
