...
CLI:
    python -m scripts.analysis.partvp.analyze_inward_outward \\
        --features scripts/analysis/partvp/data/europe_as3209_eu.parquet \\
                   scripts/analysis/partvp/data/europe_as3215_eu.parquet \\
        --out-dir scripts/analysis/partvp/analysis_eu
"""
