...
Outputs:
  - scripts/analysis/million_scale/outputs/rtt_error_scatter/rtt_error_scatter.png
  - scripts/analysis/million_scale/outputs/rtt_error_scatter/rtt_error_data.csv
  - scripts/analysis/million_scale/outputs/rtt_error_scatter/rtt_error_summary.json
"""
