"""Orchestrate the spotter_cbg_weighted target_coverage sweep across the 6 per-ASN corpora.

Pipeline per ASN:
    1. scripts/benchmark/v2/Snakefile     --configfile <stem>.yaml   (5 folds × 6 target_coverage variants)
...
Usage::
    ...
    python -m scripts.sweeps.run_spotter_sweep                       # full run
    python -m scripts.sweeps.run_spotter_sweep --asn as7018 --asn as3209
    python -m scripts.sweeps.run_spotter_sweep -j 8
    python -m scripts.sweeps.run_spotter_sweep --dry-run
    python -m scripts.sweeps.run_spotter_sweep --skip-viz
    python -m scripts.sweeps.run_spotter_sweep --skip-analysis
"""
...
CONFIGS = {
    "as7018":  "north_america_as7018_spotter_sweep",
    "as7922":  "north_america_as7922_spotter_sweep",
    "as3209":  "europe_as3209_spotter_sweep",
    "as3215":  "europe_as3215_spotter_sweep",
    "as16509": "global_as16509_spotter_sweep",
    "as31898": "global_as31898_spotter_sweep",
}
...
def main(
    ...
    """Run bench → analysis → viz for the spotter target_coverage sweep."""
