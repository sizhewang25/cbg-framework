"""Tests for the v2 snapped geometric median centroid."""
...
class TestGeometricMedianCTR(unittest.TestCase):
    def test_vertex_list_snaps_continuous_median_to_nearest_sample(self):
        ctr = GeometricMedianCTR()
        ...
        assert_coord_almost_equal(self, result.tg_coord, (0.0, 2.0))
    ...
    def test_region_sampling_returns_feasible_point(self):
        ...
        ctr = GeometricMedianCTR(n_samples=8, seed=7)
    ...
    def test_multipolygon_region_sampling_returns_feasible_point(self):
        ...
        ctr = GeometricMedianCTR(n_samples=32, seed=7)
    ...
    def test_zero_region_samples_falls_back_to_representative_point(self):
        region = rectangle_region()
        ctr = GeometricMedianCTR(n_samples=0, seed=7)
    ...
    def test_method_field_is_stamped(self):
        ...
        self.assertEqual(result.method, "GeometricMedianCTR")
