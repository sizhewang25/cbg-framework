...
from scripts.libs.core.benchmarking import (  # noqa: E402
    BenchmarkContext,
    BenchmarkRecorder,
    instrument_pipeline,
)
...
class DistanceModelCache:
    ...
    def _fit_lp(self, df_asn: Any) -> Dict:
        ...
        from scripts.libs.million_scale.evaluate_million_scale import fit_lp_models
...
def load_setting_data(
    ...
    from scripts.libs.million_scale.evaluate_million_scale import load_data
